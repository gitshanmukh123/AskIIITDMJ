...
const Navbar = () => {
 ...
 useEffect(() => {
  ...
  const navItems = [
    ...
    { name: "Lost Desk", path: "/lost-found", icon: MapPin },
    { name: "Exchange", path: "/market", icon: BookOpen },
    { name: "Study Notes", path: "/study-material", icon: GraduationCap },
    { name: "Mock Interview", path: "/ai-interview", icon: Briefcase },
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2">
            <img src={logo} alt="IIITDMJ Hub" className="w-10 h-10" />
            <span className="text-lg md:text-xl font-bold">
              <span className={logoMain}>Ask</span>
