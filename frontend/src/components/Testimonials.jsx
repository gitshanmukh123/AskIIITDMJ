...
const testimonials = [
  ...
  },
  {
    ...
    quote:
      "Sold my old textbooks quickly and safely through the application.",
    initial: "R"
  },
  {
    name: "Meera S.",
  ...
  },
  {
    ...
    role: "3rd Year, IT",
    quote:
      "Mock Interview mode helped me practice technical + HR rounds with instant feedback before placements.",
    initial: "A"
  }
]
    ...
    <section className="py-12 sm:py-16 md:py-28 px-4 sm:px-6 max-w-7xl mx-auto">
      ...
      >
        ...
        <p className={`relative ${isDark ? "text-gray-200" : "text-slate-600"} text-base sm:text-lg px-4`}>
          Real students, real results — from lost-item recovery to Study Notes and Mock Interview prep.
        </p>
      </motion.div>
