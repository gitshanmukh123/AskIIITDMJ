...
const features = [
  {
    title: "Smart Lost Desk",
    desc: "Report and match lost items fast.",
    icon: SearchCheck,
  },
  {
    title: "Book Exchange",
    desc: "Trade books and essentials on campus.",
    icon: BookOpen,
  },
  {
    title: "Real-Time Messages",
    desc: "Talk to students instantly.",
    icon: MessageCircle,
  },
  {
    title: "Study & Prep",
    desc: "Create notes and practice interviews.",
    icon: Brain,
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Simple tools for IIITDMJ campus life.
        </p>
