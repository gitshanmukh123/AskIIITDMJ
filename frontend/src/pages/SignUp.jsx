        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-6 sm:mb-8">
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-xl flex items-center justify-center mx-auto mb-3 sm:mb-4">
              <span className="text-white text-lg sm:text-xl font-bold">II</span>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <motion.div variants={itemVariants}>
              ...
              <input
                ...
                className={`w-full px-4 py-2 rounded-xl border ${inputBg}`}
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-2 rounded-xl border pr-12 ${inputBg}`}
                  placeholder="••••••••"
                />
                <button
                  type="button"
